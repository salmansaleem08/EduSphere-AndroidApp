...
//                .error(R.drawable.class_placeholder)
//                .into(bgImage)
//        } else if (classroom.imagePath != null && classroom.imagePath.isNotEmpty()) {
    ...
    fun bind(classroom: Classroom) {
        ...
        if (localFile.exists()) {
            ...
            Picasso.get()
                ...
                .error(R.drawable.class_placeholder)
                .into(bgImage)
        } else if (classroom.imagePath != null && classroom.imagePath.isNotEmpty() && File(classroom.imagePath).exists()) {
            Log.d(TAG, "Loading stored local image from path: ${classroom.imagePath}")
            Picasso.get()
                .load(File(classroom.imagePath))
                .placeholder(R.drawable.class_placeholder)
                .error(R.drawable.class_placeholder)
                .into(bgImage)
        } else {
            Log.d(TAG, "No valid image for ${classroom.classroomId}, using placeholder")
            Picasso.get()
                .load(R.drawable.class_placeholder)
                .into(bgImage)
        }
